...
do
  ...
  echo -e "\e[1;36m ___    ___  _  ___     _  _______  ______  _____   ______  ______  _____  "
  echo -e "\e[1;36m|   \  /   || ||   \   | ||__   __||  ____||  _  \ |  ____||  ____||  _  \ "
  echo -e "\e[1;36m| |\ \/ /| || || |\ \  | |   | |   | |____ | |_| | | |____ | |____ | |_| | "
  echo -e "\e[1;36m| | \__/ | || || | \ \ | |   | |   |  ____||  _  / |  __  ||  ____||  _  / "
  echo -e "\e[1;36m| |      | || || |  \ \| |   | |   | |____ | | \ \ | |__| || |____ | | \ \ "
  echo -e "\e[1;36m|_|      |_||_||_|   \___|   |_|   |______||_|  \_\|______||______||_|  \_\ "
